...
# Write proc for ping agent  Instead of a single class declaration in C++, write multiple definitions in OTcl. Each method definition (with instproc) adds a method to a class. Each instance variable definition (with set or via instvar in a method body) adds an instance variable to an object.
#recv is a virtual method in class Ping which is defined here
Agent/Ping instproc recv {from rtt} {
	$self instvar node_ 
	#The name self, which is equivalent to this in C++
