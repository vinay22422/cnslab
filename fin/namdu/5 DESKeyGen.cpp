...
{
    return s.substr(rot, s.length()-rot)   +   s.substr(0, rot) ;  //2nd parameter is not index (1st is index)
}
...
int main()
{
    ...
    cout << "\nSubKeys: " << endl;
    genKeys(key.substr(0,28) , key.substr(28,28));// from 28th post continue further for 28
    cout<<endl<<endl ;
}
